...
| <code>[binary128]</code> | 2 | 113 | -16382 | 16383 |
| <code>[decimal64]</code> | 10 | 16 | -383 | 384 |
| <code>[decimal128]</code> | 10 | 34 | -6143 | 6144 |
...
| ------ | ------------ | -------------- | ----------------------------------------------- | -------------- | ----------------------------------------------- |
| <code>[binary32]</code> | 1 * 2 ^ -23 | 1 * 2 ^ -126 | 16777215 * 2 ^ 104 | 1 * 2 ^ -149 | 8388607 * 2 ^ -149 |
| <code>[binary64]</code> | 1 * 2 ^ -52 | 1 * 2 ^ -1022 | 9007199254740991 * 2 ^ 971 | 1 * 2 ^ -1074 | 4503599627370495 * 2 ^ -1074 |
| <code>[binary128]</code> | 1 * 2 ^ -112 | 1 * 2 ^ -16382 | 10384593717069655257060992658440191 * 2 ^ 16271 | 1 * 2 ^ -16494 | 5192296858534827628530496329220095 * 2 ^ -16494 |
| <code>[decimal64]</code> | 1 * 10 ^ -15 | 1 * 10 ^ -383 | 9999999999999999 * 10 ^ 369 | 1 * 10 ^ -398 | 999999999999999 * 10 ^ -398 |
| <code>[decimal128]</code> | 1 * 10 ^ -33 | 1 * 10 ^ -6143 | 9999999999999999999999999999999999 * 10 ^ 6111 | 1 * 10 ^ -6176 | 999999999999999999999999999999999 * 10 ^ -6176 |
