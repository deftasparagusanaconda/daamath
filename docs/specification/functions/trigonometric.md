...
daamath maintains 24 non-trivial trigonometric functions, derived directly from [hypercomplex] algebrae
...
unfortunately, parabolic trigonometric functions are trivial. thus daamath excludes them and maintains 24 instead.
