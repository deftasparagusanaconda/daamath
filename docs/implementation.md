...
an implementation is a realization of the [specification] onto a programming language. the [reference implementation is in python](python). each programming language shall have exactly one canonical implementation, and spinoffs may be created under other names
...
[specification]: /daamath/specification/
