...
daamath maintains a tree of math characters each with has exactly one name and stored exactly once as the implementation's native string/character format (instead of the codepoint uint). 
