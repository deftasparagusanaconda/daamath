...
def not_(a):
    ...
    if not dm.context.not_.domains.a(a):
        raise DomainViolation('not', (a), {}, a, dm.context.not_.domains.a)

    image = dm.context.not_.mapping(a)

    if not dm.context.not_.codomain(image):
        raise CodomainViolation('not', ['a'], {}, image, dm.context.not_.codomain)
    return image

def and_(a, b):
    'conjunction'
    if not dm.context.and_.domains.a(a):
        raise DomainViolation('and', (a, b), {}, a, dm.context.and_.domains.a)
    if not dm.context.and_.domains.b(b):
        raise DomainViolation('and', (a, b), {}, b, dm.context.and_.domains.b)

    image = dm.context.and_.mapping(a, b)

    if not dm.context.and_.codomain(image):
        raise CodomainViolation('and', ['a', 'b'], {}, image, dm.context.and_.codomain)
    return image

def or_(a, b):
    'disjunction'
    if not dm.context.or_.domains.a(a):
        raise DomainViolation('or', (a, b), {}, a, dm.context.or_.domains.a)
    if not dm.context.or_.domains.b(b):
        raise DomainViolation('or', (a, b), {}, b, dm.context.or_.domains.b)

    image = dm.context.or_.mapping(a, b)

    if not dm.context.or_.codomain(image):
        raise CodomainViolation('or', ['a', 'b'], {}, image, dm.context.or_.codomain)
    return image

def xor(a, b):
    'exclusive disjunction'
    if not dm.context.xor.domains.a(a):
        raise DomainViolation('xor', (a, b), {}, a, dm.context.xor.domains.a)
    if not dm.context.xor.domains.b(b):
        raise DomainViolation('xor', (a, b), {}, b, dm.context.xor.domains.b)
...
def imp(a, b):
    ...
    if not dm.context.imp.domains.a(a):
        raise DomainViolation('imp', (a, b), {}, a, dm.context.imp.domains.a)
    if not dm.context.imp.domains.b(b):
        raise DomainViolation('imp', (a, b), {}, b, dm.context.imp.domains.b)
...
def con(a, b):
    ...
    if not dm.context.con.domains.a(a):
        raise DomainViolation('con', (a, b), {}, a, dm.context.con.domains.a)
    if not dm.context.con.domains.b(b):
        raise DomainViolation('con', (a, b), {}, b, dm.context.con.domains.b)
...
def nand(a, b):
    ...
    if not dm.context.nand.domains.a(a):
        raise DomainViolation('nand', (a, b), {}, a, dm.context.nand.domains.a)
    if not dm.context.nand.domains.b(b):
        raise DomainViolation('nand', (a, b), {}, b, dm.context.nand.domains.b)
...
def nor(a, b):
    ...
    if not dm.context.nor.domains.a(a):
        raise DomainViolation('nor', (a, b), {}, a, dm.context.nor.domains.a)
    if not dm.context.nor.domains.b(b):
        raise DomainViolation('nor', (a, b), {}, b, dm.context.nor.domains.b)
...
def nxor(a, b):
    ...
    if not dm.context.nxor.domains.a(a):
        raise DomainViolation('nxor', (a, b), {}, a, dm.context.nxor.domains.a)
    if not dm.context.nxor.domains.b(b):
        raise DomainViolation('nxor', (a, b), {}, b, dm.context.nxor.domains.b)
...
def nimp(a, b):
    ...
    if not dm.context.nimp.domains.a(a):
        raise DomainViolation('nimp', (a, b), {}, a, dm.context.nimp.domains.a)
    if not dm.context.nimp.domains.b(b):
        raise DomainViolation('nimp', (a, b), {}, b, dm.context.nimp.domains.b)
...
def ncon(a, b):
    ...
    if not dm.context.ncon.domains.a(a):
        raise DomainViolation('ncon', (a, b), {}, a, dm.context.ncon.domains.a)
    if not dm.context.ncon.domains.b(b):
        raise DomainViolation('ncon', (a, b), {}, b, dm.context.ncon.domains.b)
