...
these quantize functions always map an integer directly to an integer. 

the left and right operators differ only by "is this directed rounding or not?"

what they both have in common is how they round ties like …, -1.5, -0.5, +0.5, +1.5, …  
we can take advantage of this and describe these by a sequence of bits. the bits describe how they round ties.
...
so we realize these are parameterized by bit sequences
