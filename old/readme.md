...
[📖 docs][docs] | [🔍 examples][examples] | [💡suggest silly ideas!][contact]

# daamath

a mathematician's spellbook. its the most coherent math library up to date

features: 
- language-agnostic specification
- cross-language consistency
- domain-aware arithmetic
