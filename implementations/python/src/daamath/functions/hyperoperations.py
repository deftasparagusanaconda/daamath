...
def succ(a):
    ...
    if not dm.context.succ.domains.a(a):
        raise DomainViolation('succ', (a), {}, a, dm.context.succ.domains.a)
...
def pred(b):
    ...
    if not dm.context.pred.domains.b(b):
        raise DomainViolation('pred', (b), {}, b, dm.context.pred.domains.b)
...
def add(a, b):
    ...
    if not dm.context.add.domains.a(a):
        raise DomainViolation('add', (a, b), {}, a, dm.context.add.domains.a)
    if not dm.context.add.domains.b(b):
        raise DomainViolation('add', (a, b), {}, b, dm.context.add.domains.b)
...
def sub(c, b):
    ...
    if not dm.context.sub.domains.c(c):
        raise DomainViolation('sub', (c, b), {}, c, dm.context.sub.domains.c)
    if not dm.context.sub.domains.b(b):
        raise DomainViolation('sub', (c, b), {}, b, dm.context.sub.domains.b)
...
def bus(c, a):
    ...
    if not dm.context.bus.domains.c(c):
        raise DomainViolation('bus', (c, a), {}, c, dm.context.bus.domains.c)
    if not dm.context.bus.domains.a(a):
        raise DomainViolation('bus', (c, a), {}, a, dm.context.bus.domains.a)
...
def mul(a, b):
    ...
    if not dm.context.mul.domains.a(a):
        raise DomainViolation('mul', (a, b), {}, a, dm.context.mul.domains.a)
    if not dm.context.mul.domains.b(b):
        raise DomainViolation('mul', (a, b), {}, b, dm.context.mul.domains.b)
...
def div(c, b):
    ...
    if not dm.context.div.domains.c(c):
        raise DomainViolation('div', (c, b), {}, c, dm.context.div.domains.c)
    if not dm.context.div.domains.b(b):
        raise DomainViolation('div', (c, b), {}, b, dm.context.div.domains.b)
...
def vid(c, a):
    ...
    if not dm.context.vid.domains.c(c):
        raise DomainViolation('vid', (c, a), {}, c, dm.context.vid.domains.c)
    if not dm.context.vid.domains.a(a):
        raise DomainViolation('vid', (c, a), {}, a, dm.context.vid.domains.a)
...
def pow(a, b):
    ...
    if not dm.context.pow.domains.a(a):
        raise DomainViolation('pow', (a, b), {}, a, dm.context.pow.domains.a)
    if not dm.context.pow.domains.b(b):
        raise DomainViolation('pow', (a, b), {}, b, dm.context.pow.domains.b)
...
def log(c, b):
    ...
    if not dm.context.log.domains.c(c):
        raise DomainViolation('log', (c, b), {}, c, dm.context.log.domains.c)
    if not dm.context.log.domains.b(b):
        raise DomainViolation('log', (c, b), {}, b, dm.context.log.domains.b)
...
def root(c, a):
    ...
    if not dm.context.root.domains.c(c):
        raise DomainViolation('root', (c, a), {}, c, dm.context.root.domains.c)
    if not dm.context.root.domains.a(a):
        raise DomainViolation('root', (c, a), {}, a, dm.context.root.domains.a)
